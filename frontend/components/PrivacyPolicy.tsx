    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 py-12 space-y-8">
        ...
        <section className="bg-white rounded-lg shadow-md p-6 space-y-4">
          ...
          <p className="text-gray-700">
            kipclip does not store your bookmarks. The only data we persist on
            our side is:
          </p>
          <ul className="list-disc pl-5 text-gray-700 space-y-2">
            <li>
              <strong>OAuth session tokens</strong>{" "}
              — temporary credentials used to keep you signed in. These are
              stored in a database and automatically expire.
            </li>
            <li>
          ...
          <p className="text-gray-700">
            We do not maintain a user database, profile store, or any copy of
            your bookmarks.
          </p>
        </section>
        ...
        <section className="bg-white rounded-lg shadow-md p-6 space-y-4">
          ...
          <p className="text-gray-700">
            ...
            site is used — such as page views and referral sources. This
            tracking is entirely self-hosted and does not use any third-party
            analytics services. No data is shared with advertisers, data
            brokers, or external companies.
          </p>
          <p className="text-gray-700">
            We do not use tracking pixels, fingerprinting, or cross-site
        ...
        <section className="bg-white rounded-lg shadow-md p-6 space-y-4">
          ...
          <p className="text-gray-700">
            kipclip connects to the following external services as part of
            normal operation:
          </p>
          <ul className="list-disc pl-5 text-gray-700 space-y-2">
            <li>
