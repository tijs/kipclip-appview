    ...
    <PageShell>
      ...
      <section className="bg-white rounded-lg shadow-md p-6 space-y-4">
        ...
        <p className="text-gray-700">
          kipclip is a free, open-source bookmark manager built on AT Protocol.
          It lets you save, organize, and share links using your existing AT
          Protocol account. By using kipclip, you agree to these terms.
        </p>
      </section>
      ...
      <section className="bg-white rounded-lg shadow-md p-6 space-y-4">
        ...
        <p className="text-gray-700">
          ...
          responsible for keeping your account credentials secure. kipclip never
          has access to your password.
        </p>
      </section>
      ...
      <section className="bg-white rounded-lg shadow-md p-6 space-y-4">
        ...
        <p className="text-gray-700">
          All bookmarks and tags you save through kipclip are stored publicly on
          your Personal Data Server (PDS). This means anyone can view your
      ...
      <section className="bg-white rounded-lg shadow-md p-6 space-y-4">
        ...
        <p className="text-gray-700">
          ...
          servers. kipclip acts as a client to read and write this data on your
          behalf. We do not control or moderate the content of your bookmarks.
        </p>
      </section>
      ...
      <section className="bg-white rounded-lg shadow-md p-6 space-y-4">
        ...
        <p className="text-gray-700">
          ...
          availability. We may update, change, or discontinue the service at any
          time. Since your data lives on your PDS, it remains accessible through
          other AT Protocol clients even if kipclip becomes unavailable.
        </p>
      </section>
      ...
      <section className="bg-white rounded-lg shadow-md p-6 space-y-4">
        ...
        <p className="text-gray-700">
          You agree not to misuse kipclip. This includes but is not limited to:
        </p>
      ...
      <section className="bg-white rounded-lg shadow-md p-6 space-y-4">
        ...
        <p className="text-gray-700">
          We may update these terms from time to time. Continued use of kipclip
