      ...
      <section id="using-kipclip">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 space-y-6">
          ...
          <div>
            ...
            <p className="text-gray-700">
              Enter your username (like alice.bsky.social) on the sign-in page.
              You'll be securely redirected to authorize kipclip, then sent
              back. Your password is never shared with kipclip.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-700">
              In your own account, not on kipclip's servers. You own your data,
              and other compatible apps can access your bookmarks too.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-700">
              ...
              others. Don't save anything sensitive or private. Think of kipclip
          ...
          <div>
            ...
            <p className="text-gray-700">
              Your bookmarks stay safe in your account. They're not locked into
              kipclip — you could use another compatible app, or even host your
              own copy since kipclip is open source.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-700">
              kipclip is free to use. If you'd like to help keep it running and
              fund future development, visit the{" "}
              <a
                href="/support"
                className="underline hover:text-gray-800"
              >
        ...
        <div className="bg-white rounded-lg shadow-md p-6 space-y-6">
          <div>
            ...
            <p className="text-gray-700">
              ...
              email — you own your address and can use it with different
              clients.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-700">
              ...
              bookmarks, and everything else. When you create a Bluesky account,
              you get a PDS automatically. Your bookmarks are stored there as
              structured records, which is why they stay with you even if
              kipclip goes away.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-700">
              ...
              it. Because they share the same account system and data standards,
              you can use one account across all of them and take your data with
              you.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-700">
              ...
              and Eurosky are popular providers — and more are being developed.
              You can create an account with any provider and use it across all
              Atmosphere apps including kipclip.
            </p>
          </div>
